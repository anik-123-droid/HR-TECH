          ...
          <div className="bg-white rounded-3xl w-full max-w-2xl relative z-10 overflow-hidden shadow-2xl flex flex-col max-h-[90vh]">
                ...
                <div className="animate-in slide-in-from-bottom-4 duration-500 space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5 md:col-span-2">
                      <label className="text-[12px] font-bold text-slate-500 uppercase tracking-wider">Extracted Skills</label>
                      <div className="w-full px-3 py-2.5 border border-green-300 bg-green-50/30 rounded-lg flex flex-wrap gap-2 items-center">
                        {candidateProfile.skills.map(s => (
                          <span key={s} className="px-2 py-0.5 bg-white border border-green-200 text-green-700 rounded text-[12px] font-bold flex items-center gap-1 shadow-sm">
                            {s}
                          </span>
                        ))}
                  ...
                  <div className="pt-2 border-t border-slate-100">
                    <h4 className="text-[14px] font-bold text-emerald-900 mb-4">Additional Details (Not in Resume)</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-1.5">
            ...
            <div className="px-6 py-4 border-t border-slate-100 bg-slate-50 flex items-center justify-end gap-3 mt-auto">
              ...
              {modalStep === 2 && (
                ...
                >
                  Submit Application & Update Master Profile
                </button>
              )}
            </div>
          </div>
