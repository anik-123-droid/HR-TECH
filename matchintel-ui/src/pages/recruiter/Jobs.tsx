  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="font-display text-3xl font-extrabold text-emerald-900 tracking-tight">Active Requisitions</h1>
      ...
      {jobs.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-3.5">
            {filledJobs.map(card => (
              <div key={card.id} className="border border-slate-200 rounded-2xl p-5 hover:border-green-300 hover:shadow-md transition-all bg-white shadow-xs cursor-pointer opacity-90">
                <div className="flex items-start justify-between mb-2">
                  <h3 className="font-display text-[15px] font-bold text-emerald-900 leading-snug">{card.title}</h3>
